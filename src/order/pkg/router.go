...
func Route(e *echo.Echo) {
	...
	e.GET("/orders/all", OrderIndex)
	e.GET("/orders/id/:orderID", OrderShowByID)
	e.GET("/orders/username/:username", OrderIndexByUsername)

	e.POST("/orders", OrderCreate)
	e.OPTIONS("/orders", OrderCreate)

	e.PUT("/orders/id/:orderID", OrderUpdate)
	e.OPTIONS("/orders/id/:orderID", OrderUpdate)
}
