<template>
  <ArticleLayout>
    ...
    <p>
      To provide a more compelling and intuitive demo experience, each fictitious user in the 애니커머스 is
      assigned a shopper persona. The persona is represented by three categories from the 애니커머스’s catalog
