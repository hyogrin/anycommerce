<template>
  <ArticleLayout>
    ...
    <p>
      The
      <a href="https://github.com/aws-samples/retail-demo-store" target="_blank" rel="noreferrer noopener">애니커머스</a>
      is an open source solution which integrates Amazon Personalize, Amazon Pinpoint and Amazon Lex in a retail web
      application demo and workshop platform. The 애니커머스 is intended to be used as an education tool (not
    ...
    <p>
      The 애니커머스 is a fictitious online store that includes users (shoppers), products, carts and orders as
    ...
    <section class="my-4">
      ...
      <p>
        The core of the 애니커머스 is a polyglot microservice architecture deployed as a collection of RESTful
        ...
        <a href="https://github.com/aws-samples/retail-demo-store/tree/master/workshop" target="_blank"
          rel="noreferrer noopener">workshops page</a>
        for details.
      </p>

      <div class="my-4"><img src="/rds-architecture.png" alt="애니커머스 architecture" class="img-fluid" /></div>
    </section>

    <section class="my-4">
      <h2 class="section-heading">How the 애니커머스 works</h2>

      <p>
        The 애니커머스 is designed to display how personalization works and the impact it can have on a shoppers
