<template>
  <ArticleLayout>
    ...
    <p>
      The 애니커머스 uses all
      <a href="https://docs.aws.amazon.com/personalize/latest/dg/how-it-works-dataset-schema.html" target="_blank"
        rel="noreferrer noopener">three supported dataset types</a>
      ...
      interactions dataset. AWS Amplify is used to send events to the 애니커머스’s Personalize Event Tracker.
    </p>
