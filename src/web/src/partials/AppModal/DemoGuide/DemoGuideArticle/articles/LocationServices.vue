    ...
    <ArticleFeature>
      ...
      <template #default>
        <p>
          ...
          First, ensure you are deploying 애니커머스 in a region in which
        ...
        <p>
          From any 애니커머스 "Shop" menu You can access the Location "In-Store View"
        ...
        <p>
          ...
          <a
            href="https://github.com/aws-samples/retail-demo-store/blob/master/workshop/4-Messaging/4.1-Pinpoint.ipynb">
        ...
        <ol>
          ...
          <li>Enable 2-way messaging on that long-code and choose the SNS PinpointIncomingTextAlerts
            topic that was deployed along with 애니커머스 to send messages to, so that responses
