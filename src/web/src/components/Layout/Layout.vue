<template>
  <div :class="{ 'layout--has-nav': showNav, 'layout--has-demo-guide': showDemoGuide }">
    ...
    <PreviousPageLink v-if="!isLoading && previousPageLinkProps" :to="previousPageLinkProps.to"
      :text="previousPageLinkProps.text" class="container mb-2"></PreviousPageLink>
