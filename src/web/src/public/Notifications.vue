          ...
          if (messageData.EventType === "PURCHASE") {
            RecommendationsRepository.getCouponOffer(this.user.id)
              .then((offer_recommendation) => {
                ...
                swal({
                  title: 'Store nearby',
                  text: `We noticed that you are close to your Local AWS 애니커머스. Pop into our store near you, check our newest collection, and use the code: ${offer.codes[0]} for any purchase and get ${offer.description}.`,
                  content: offerDiv
                });
              });
            ...
            Promise.all(ordersHtml).then((responses) => {
              ...
              swal({
                ...
                text: `Welcome! We are waiting for you at Level 3, Door 2 of your Local 애니커머스, and Steve from our team will be greeting you with your following order(s):`,
